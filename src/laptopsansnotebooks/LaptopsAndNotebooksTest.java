...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-payment-firstname']"),"jalpa");
        sendTextOnElement(By.xpath("//input[@id='input-payment-lastname']"),"kalpesh");
        sendTextOnElement(By.xpath("//input[@id='input-payment-email']"),"jalpa13@gmail.com");
        sendTextOnElement(By.xpath("//input[@id='input-payment-telephone']"),"231jk");
        sendTextOnElement(By.xpath("//input[@id='input-payment-address-1']"),"1234j, Alperton");
        sendTextOnElement(By.xpath("//input[@id='input-payment-city']"),"London");
        sendTextOnElement(By.xpath("//input[@id='input-payment-postcode']"),"HA0 1AE");
